...
public class RegistrationTest extends TestUtil {
    ...
    public void executeSignUp(String name, String surname, String mail, String pass, String gsm, String day, String year) {
        ...
        registrationPage.submitName(name);
        registrationPage.submitSurname(surname);
        registrationPage.submitEmail(mail);
        registrationPage.submitPassword(pass);
        registrationPage.submitPhone(gsm);
        registrationPage.selectMonth();
        registrationPage.submitDayOfBirth(day);
        registrationPage.submitYearOfBirth(year);
